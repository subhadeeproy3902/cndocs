...
<img className="max-w-xl rounded-xl mx-auto" src="https://media.geeksforgeeks.org/wp-content/uploads/leakyTap-1.png" alt="Leaky Bucket Algorithm" />
...
<img className="max-w-xl rounded-xl mx-auto" src="https://media.geeksforgeeks.org/wp-content/uploads/20240116162804/Blank-diagram-(7).png" alt="Token Bucket Algorithm" />
