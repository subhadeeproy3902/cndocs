...
<img className="max-w-xl rounded-xl mx-auto" src="/images/screenshot-2023-05-29-102548.webp" alt="HTTP Connection" />
...
<img className="max-w-xl rounded-xl mx-auto" src="/images/imageofhttprequestresponse-1024x580-660.webp" alt="HTTP Response" />
