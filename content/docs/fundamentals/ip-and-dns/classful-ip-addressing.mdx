...
<img className="max-w-xl mx-auto" src="/images/IP_addressing_1.jpg" alt="Dotted Decimal Notation" />

### Hexadecimal Notation

<img className="max-w-xl mx-auto" src="/images/hex-notation.jpg" alt="Hexadecimal Notation" />
...
<img className="max-w-xl mx-auto" src="/images/IP_addressing_3.jpg" alt="Classful Addressing" />
...
<img className="max-w-xl mx-auto" src="/images/classful-address-space.png" alt="Occupation of The Address Space In Classful Addressing" />
...
<img className="max-w-xl mx-auto" src="/images/IP_addressing_4.jpg" alt="Class A" />
...
<img className="max-w-xl mx-auto" src="/images/IP_addressing_5.jpg" alt="Class B" />
...
<img className="max-w-xl mx-auto" src="/images/IP_addressing_6.jpg" alt="Class C" />
...
<img className="max-w-xl mx-auto" src="/images/IP_addressing_7.jpg" alt="Class D" />
...
<img className="max-w-xl mx-auto" src="/images/IP_addressing_8.jpg" alt="Class E" />
...
<img className="max-w-xl mx-auto" src="/images/nethostdata.jpg" alt="Summary of Classful addressing" />
