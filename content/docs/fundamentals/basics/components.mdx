...
<img src="https://resource.fs.com/mall/generalImg/DIUkbfYDdoYxVJxsGhXcgModnWh.jpeg" className="max-w-xl rounded-xl mx-auto rounded-xl" />
...
<div className="flex flex-col justify-center items-center max-w-xl rounded-xl mx-auto">
...
<img src="https://media.geeksforgeeks.org/wp-content/uploads/20240904122344/Network-Switch-01-copy.webp" className="max-w-xl rounded-xl mx-auto rounded-xl" />
...
<img src="https://media.geeksforgeeks.org/wp-content/uploads/20230828190552/IMG-20230828-WA0013.jpg" className="max-w-xl rounded-xl mx-auto rounded-xl" />
