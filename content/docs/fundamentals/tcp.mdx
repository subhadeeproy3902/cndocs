...
<img className="max-w-xl w-full rounded-xl mx-auto" src="/images/tcp-ip-model-2.webp" alt="TCP/IP Model" />
...
<img className="max-w-xl w-full rounded-xl mx-auto" src="/images/tcp-ip-vs-osi.webp" alt="TCP/IP vs OSI Model" />
...
<img className="max-w-xl w-full rounded-xl mx-auto" src="/images/tcp-ip-model-1.webp" alt="TCP/IP Working Model" />
...
<img className="max-w-xl w-full rounded-xl mx-auto" src="/images/tcp-segment-header.png" alt="TCP Segment Header" />
...
<img className="max-w-xl w-full rounded-xl mx-auto" src="/images/tcp-handshake-1.png" alt="TCP 3-Way Handshake" />
...
<img className="max-w-xl w-full rounded-xl mx-auto" src="/images/tcp-connection.png" alt="TCP Connection Establishment" />
