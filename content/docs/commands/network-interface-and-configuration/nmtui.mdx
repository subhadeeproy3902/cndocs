...
<img className="max-w-xl rounded-xl mx-auto" src="/images/nmtui-command.png" alt="NMTUI Main Interface" />
...
<img className="max-w-xl rounded-xl mx-auto" src="/images/nmtui-edit-connection.png" alt="NMTUI Edit Connection Screen" />
...
<img className="max-w-xl rounded-xl mx-auto" src="/images/nmtui-ip-config.png" alt="NMTUI IPv4 Configuration" />
