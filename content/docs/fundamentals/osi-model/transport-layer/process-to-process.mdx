...
<img className="max-w-xl rounded-xl mx-auto" src="https://media.geeksforgeeks.org/wp-content/cdn-uploads/CN_Multiplexing-1.jpg" alt="Multiplexing and Demultiplexing" />
