...
<img className="max-w-xl rounded-xl mx-auto" src="/images/untitled-diagram-125.jpg" alt="System Architecture" />
...
<img className="max-w-xl rounded-xl mx-auto" src="/images/www-660.jpg" alt="WWW" />
