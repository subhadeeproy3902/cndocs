...
<img className="max-w-xl rounded-xl mx-auto" src="https://www.davepacheco.net/blog/2006/event-ports-and-performance/tiny.png" alt="select() vs epoll() Performance" />
...
<img className="max-w-xl rounded-xl mx-auto" src="https://media.geeksforgeeks.org/wp-content/uploads/20230216153935/Level-triggering.png" alt="Level-Triggered vs Edge-Triggered" />
