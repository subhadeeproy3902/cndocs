...
<img className="max-w-xl rounded-xl mx-auto" src="https://yoginsavani.com/wp-content/uploads/2023/05/Big-endian-and-Little-endian.png" alt="Big-Endian vs Little-Endian" />
