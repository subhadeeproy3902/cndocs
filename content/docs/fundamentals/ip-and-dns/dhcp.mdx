...
<img className="max-w-xl rounded-xl mx-auto" src="/images/dhcp-packet-format.png" alt="DHCP Packet Format" />
...
<img className="max-w-xl rounded-xl mx-auto" src="/images/dhcp-working.png" alt="Working of DHCP" />
...
<img className="max-w-xl rounded-xl mx-auto" src="/images/dhcp-discover.png" alt="DHCP Discover Message" />
...
<img className="max-w-xl rounded-xl mx-auto" src="/images/dhcp-offer.png" alt="DHCP Offer Message" />
...
<img className="max-w-xl rounded-xl mx-auto" src="/images/dhcp-request.png" alt="DHCP Request Message" />
...
<img className="max-w-xl rounded-xl mx-auto" src="/images/dhcp-acknowledgement.png" alt="DHCP Acknowledgment Message" />
