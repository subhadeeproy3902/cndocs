...
<img className="max-w-xl rounded-xl mx-auto" src="https://media.geeksforgeeks.org/wp-content/uploads/20220420215511/Blocking.png" alt="Blocking Socket Operation" />
...
<img className="max-w-xl rounded-xl mx-auto" src="https://miro.medium.com/v2/resize:fit:1400/1*uGTFBoxMJKezJPyoPa8Vlg.png" alt="Non-blocking Socket Operation" />
