...
<img className="max-w-xl mx-auto" src="/images/apipa1.png" alt="APIPA Concept" />
...
<img className="max-w-xl mx-auto" src="/images/apipa2.png" alt="Working of APIPA" />
...
<img className="max-w-xl mx-auto" src="/images/apipa-summary.png" alt="APIPA Summary" />
