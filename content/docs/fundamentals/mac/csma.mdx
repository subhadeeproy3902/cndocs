...
<img className="max-w-xl rounded-xl mx-auto" src="/images/csma-example.png" alt="CSMA Example" />
...
<img className="max-w-xl rounded-xl mx-auto" src="/images/csma-cd-example.png" alt="CSMA/CD Example" />
...
<img className="max-w-xl rounded-xl mx-auto" src="/images/csma-cd-flowchart.png" alt="CSMA/CD Flowchart" />
...
<img className="max-w-xl rounded-xl mx-auto" src="/images/collision-detection-1.png" alt="Collision Detection Example 1" />
...
<img className="max-w-xl rounded-xl mx-auto" src="/images/collision-detection-2.png" alt="Collision Detection Example 2" />
...
<img className="max-w-xl rounded-xl mx-auto" src="/images/csma-ca-flowchart.png" alt="CSMA/CA Flowchart" />
