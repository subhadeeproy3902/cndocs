...
<img className="max-w-xl mx-auto" src="https://technologyrss.com/wp-content/uploads/2017/07/see-ip-address-using-command-line.png" alt="ifconfig command output showing network interfaces" />
