...
<img className="max-w-xl rounded-xl mx-auto" src="/images/ipv6-address.webp" alt="IPv6 address format" />
...
<img className="max-w-xl rounded-xl mx-auto" src="/images/IPv6-Represantation.png" alt="IPv6 Representation" />
