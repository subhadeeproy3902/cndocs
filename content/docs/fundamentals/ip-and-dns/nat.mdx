...
<img className="max-w-xl mx-auto" src="/images/nat-diagram.jpg" alt="Network Address Translation" />
...
<img className="max-w-xl mx-auto" src="/images/nat-addresses.png" alt="NAT Inside and Outside Addresses" />
